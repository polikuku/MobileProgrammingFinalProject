...
* Created by Xnote on 2015-12-18.
        */
public class FunnyMemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funnymem);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FunnyMemActivity.this, MemMapActivity.class);
    ...
    public void selectAll() {
        String sql = "select * from " + "funnyListTable" + ";";
