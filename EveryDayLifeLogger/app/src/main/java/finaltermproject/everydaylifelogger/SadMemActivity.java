...
* Created by Xnote on 2015-12-18.
        */
public class SadMemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sadmem);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SadMemActivity.this, MemMapActivity.class);
    ...
    public void selectAll() {
        String sql = "select * from " + "sadListTable" + ";";
